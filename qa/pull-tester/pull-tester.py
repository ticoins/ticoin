#!/usr/bin/python
# Copyright (c) 2013 The ticoin Core developers
...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old ticoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/ticoindComparisonTool_jar/ticoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/ticoin/ticoin.git")
...
environ_default("BUILD_PATH", "/mnt/ticoin")
...
environ_default("GITHUB_REPO", "ticoin/ticoin")
