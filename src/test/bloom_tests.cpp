/**-5-10Copyright (c) 2012-2013 The ticoin Core developers
...
BOOST_AUTO_TEST_CASE(bloom_create_insert_serialize)
{
    ...
    /**-5-10One bit different in first byte
...
{
    /**-5-10Same test as bloom_create_insert_serialize, but we add a nTweak of 100
...
{
    /**-5-10Random real transaction (b4749f017444b051c44dfd2720e88f314ff94f3dd6d56d40ef65854fcd7fff6b)
    CTransaction tx;
    ...
    /**-5-10and one which spends it (e2769b09e784f32f62ef849763d4f45b98e07ba658647343b915ff832b110436)
...
{
    /**-5-10Random real block (0000000000013b8ab2cd513b0261a14096412195a72a0c4827d229dcc7e0f7af)
    /**-5-10With 9 txes
    CBlock block;
    ...
    CBloomFilter filter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    /**-5-10Match the last transaction
    ...
    /**-5-10Also match the 8th transaction
...
{
    /**-5-10Random real block (000000005a4ded781e667e06ceefafb71410b511fe0d5adc3e5a27ecbec34ae6)
    /**-5-10With 4 txes
    CBlock block;
    ...
    CBloomFilter filter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    /**-5-10Match the first transaction
    ...
    /**-5-10Match an output from the second transaction (the pubkey for address 1DZTzaBHUDM7T3QvUKBz4qXMRpkg8jsfB5)
    /**-5-10This should match the third transaction because it spends the output matched
    /**-5-10It also matches the fourth transaction, which spends to the pubkey again
...
BOOST_AUTO_TEST_CASE(merkle_block_2_with_update_none)
{
    ...
    /**-5-10Match an output from the second transaction (the pubkey for address 1DZTzaBHUDM7T3QvUKBz4qXMRpkg8jsfB5)
    /**-5-10This should not match the third transaction though it spends the output matched
    /**-5-10It will match the fourth transaction, which has another pay-to-pubkey output to the same address
    filter.insert(ParseHex("044a656f065871a353f216ca26cef8dde2f03e8c16202d2e8ad769f02032cb86a5eb5e56842e92e19141d60a01928f8dd2c875a390f67c1f6c94cfc617c0ea45af"));
...
{
    /**-5-10Random real block (000000000000dab0130bbcc991d3d7ae6b81aa6f50a798888dfe62337458dc45)
    /**-5-10With one tx
    CBlock block;
    ...
    CBloomFilter filter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    /**-5-10Match the only transaction
...
{
    /**-5-10Random real block (000000000000b731f2eef9e8c63173adfb07e41bd53eb0ef0a6b720d6cb6dea4)
    /**-5-10With 7 txes
    CBlock block;
    ...
    /**-5-10Also match the 4th transaction
...
BOOST_AUTO_TEST_CASE(merkle_block_4_test_p2pubkey_only)
{
    ...
    /**-5-10Match the generation pubkey
...
BOOST_AUTO_TEST_CASE(merkle_block_4_test_update_none)
{
    ...
    /**-5-10We shouldn't match any outpoints (UPDATE_NONE)
    BOOST_CHECK(!filter.contains(COutPoint(uint256("0x147caa76786596590baa4e98f5d9f48b86c7765e489f7a6ff3360fe5c674360b"), 0)));
    BOOST_CHECK(!filter.contains(COutPoint(uint256("0x02981fa052f0481dbc5868f4fc2166035a10f27a03cfd2de67326471df5bc041"), 0)));
}
