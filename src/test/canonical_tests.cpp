...
//
/**-5-10Unit tests for canonical signatures
//
...
/**-5-10OpenSSL-based test for canonical signature (without test for hashtype byte)
...
/**-5-10OpenSSL-based test for canonical signature
