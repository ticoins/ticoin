...
{
    BOOST_CHECK(TestSplitHost("www.ticoin.org", "www.ticoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.ticoin.org]", "www.ticoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.ticoin.org:80", "www.ticoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.ticoin.org]:80", "www.ticoin.org", 80));
...
{
    /**-5-10values from https://web.archive.org/web/20121122003543/http://www.cypherpunk.at/onioncat/wiki/OnionCat
