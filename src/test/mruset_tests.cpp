...
/**-5-10Test that an mruset behaves like a set, as long as no more than MAX_SIZE elements are in it
...
/**-5-10Test that an mruset's size never exceeds its max_size
...
/**-5-1016-bit permutation function
int static permute(int n)
{
    /**-5-10hexadecimals of pi; verified to be linearly independent
...
/**-5-10Test that an mruset acts like a moving window, if no duplicate elements are added
