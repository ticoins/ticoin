...
{
    /**-5-10Test raw transaction API argument handling
    Value r;
    ...
    /**-5-10Only check failure cases for sendrawtransaction, there's no network to send to...
...
{
    Value r;
    /**-5-10input is a 1-of-2 multisig (so is output):
    string prevout =
