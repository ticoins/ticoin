...
//ticoin Some environments provide custom macros to aid in static thread-safety
//ticoin analysis.  Provide empty definitions of such macros unless they are already
//ticoin defined.
...
#endif  //ticoin STORAGE_LEVELDB_PORT_THREAD_ANNOTATIONS_H
