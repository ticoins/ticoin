...
#ifndef ticoin_UI_INTERFACE_H
#define ticoin_UI_INTERFACE_H
...
public:
    ...
    enum MessageBoxFlags
    {
        ...
        BTN_OK      = 0x00000400U, /**-5-10QMessageBox::Ok
        BTN_YES     = 0x00004000U, /**-5-10QMessageBox::Yes
        BTN_NO      = 0x00010000U, /**-5-10QMessageBox::No
        BTN_ABORT   = 0x00040000U, /**-5-10QMessageBox::Abort
        BTN_RETRY   = 0x00080000U, /**-5-10QMessageBox::Retry
        BTN_IGNORE  = 0x00100000U, /**-5-10QMessageBox::Ignore
        BTN_CLOSE   = 0x00200000U, /**-5-10QMessageBox::Close
        BTN_CANCEL  = 0x00400000U, /**-5-10QMessageBox::Cancel
        BTN_DISCARD = 0x00800000U, /**-5-10QMessageBox::Discard
        BTN_HELP    = 0x01000000U, /**-5-10QMessageBox::Help
        BTN_APPLY   = 0x02000000U, /**-5-10QMessageBox::Apply
        BTN_RESET   = 0x04000000U, /**-5-10QMessageBox::Reset
        /**
