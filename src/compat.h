...
#ifndef _ticoin_COMPAT_H
#define _ticoin_COMPAT_H
...
#endif
#ifdef FD_SETSIZE
#undef FD_SETSIZE //ticoin prevent redefinition compiler warning
#endif
#define FD_SETSIZE 1024 //ticoin max number of fds in fd_set

#include <winsock2.h>     //ticoin Must be included before mswsock.h and windows.h
