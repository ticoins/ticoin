...
namespace json_spirit
{
    ...
    template< class Config >    //ticoin Config determines whether the value uses std::string or std::wstring and
                                //ticoin whether JSON Objects are represented as vectors or maps
    class Value_impl
    {
    public:
        ...
        typedef typename String_type::const_pointer Const_str_ptr;  //ticoin eg const char*

        Value_impl();  //ticoin creates null value
        ...
        template< typename T > T get_value() const;  //ticoin example usage: int    i = value.get_value< int >();
                                                     //ticoin or             double d = value.get_value< double >();
    ...
    void Value_impl< Config >::check_type( const Value_type vtype ) const
    {
        if( type() != vtype ) 
        {
            ...
            /////ticoin ticoin: Tell the types by name instead of by number
    ...
    //ticoin converts a C string, ie. 8 bit char array, to a string object
    //
