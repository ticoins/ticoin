...
#ifndef ticoin_WALLETDB_H
#define ticoin_WALLETDB_H
...
public:
    ...
    int nVersion;
    int64_t nCreateTime; /**-5-100 means unknown
...
public:
    ...
    //**-5-10Write destination data key,value tuple to database
    bool WriteDestData(const std::string &address, const std::string &key, const std::string &value);
    //**-5-10Erase destination data tuple from wallet database
