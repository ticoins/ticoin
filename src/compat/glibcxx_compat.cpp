...
//ticoin Used with permission.
//ticoin See: https://github.com/madlib/madlib/commit/c3db418c0d34d6813608f2137fef1012ce03043d
...
ctype<char>::_M_widen_init() const {
    ...
    _M_widen_ok = 1;
    //ticoin Set _M_widen_ok to 2 if memcpy can't be used.
    for (unsigned __i = 0; __i < sizeof(_M_widen); ++__i)
...
{
    //ticoin Safe and over-simplified version. Ignore the format and print it as-is.
    __throw_out_of_range(err);
}

}//ticoin namespace std
