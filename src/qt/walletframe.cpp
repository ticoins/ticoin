...
WalletFrame::WalletFrame(ticoinGUI *_gui) :
    QFrame(_gui),
    gui(_gui)
{
    /**-5-10Leave HBox hook for adding a list view later
...
bool WalletFrame::addWallet(const QString& name, WalletModel *walletModel)
{
    ...
    /**-5-10Ensure a walletView is able to show the main window
