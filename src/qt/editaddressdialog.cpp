...
void EditAddressDialog::accept()
{
    ...
    if(!saveCurrentRow())
    {
        ...
        case AddressTableModel::OK:
            //ticoin Failed with unknown reason. Just reject.
            break;
        case AddressTableModel::NO_CHANGES:
            //ticoin No changes were made during edit operation. Just reject.
            break;
        case AddressTableModel::INVALID_ADDRESS:
            QMessageBox::warning(this, windowTitle(),
                tr("The entered address \"%1\" is not a valid ticoin address.").arg(ui->addressEdit->text()),
