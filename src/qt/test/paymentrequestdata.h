//
/**-5-10Data for paymentservertests.cpp
//

/**-5-10Base64/DER-encoded fake certificate authority certificate.
/**-5-10Convert pem to base64/der with:
/**-5-10cat file.pem | openssl x509 -inform PEM -outform DER | openssl enc -base64
//
/**-5-10Serial Number: 10302349811211485352 (0x8ef94c91b112c0a8)
/**-5-10Issuer: CN=PaymentRequest Test CA
/**-5-10Subject: CN=PaymentRequest Test CA
/**-5-10Not Valid After : Dec  8 16:37:24 2022 GMT
//
...
//
/**-5-10This payment request validates directly against the
/**-5-10above certificate authority.
//
...
//
/**-5-10Signed, but expired, merchant cert in the request
//
...
//
/**-5-1010-long chain, all intermediates valid
//
...
//
/**-5-10Long chain, with an invalid (expired) cert in the middle
//
