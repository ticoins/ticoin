...
#include "main.h" /**-1-12for CTransaction::nMinTxFee and MAX_SCRIPTCHECK_THREADS
#include "netbase.h"
    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new ticoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ticoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning(bool fPersistent)
{
    ...
    else
    {
        ...
        /**-1-12clear non-persistent status label after 10 seconds
        /**-1-12Todo: should perhaps be a class attribute, if we extend the use of statusLabel
