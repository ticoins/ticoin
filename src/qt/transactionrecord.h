...
public:
    ...
    enum Status {
        ...
        //**-5-10Normal (sent/received) transactions
        ...
        //**-5-10Generated (mined) transactions
        Immature,           /**< Mined but waiting for maturity */
        MaturesWarning,     /**< Transaction will likely not mature because no nodes have confirmed */
        NotAccepted         /**< Mined but not accepted */
    };

    //**-5-10Transaction counts towards available balance
    bool countsForBalance;
    //**-5-10Sorting key based on status
    std::string sortKey;
