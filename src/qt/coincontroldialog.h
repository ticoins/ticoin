...
public:
    ...
    //ticoin static because also called from sendcoinsdialog
...
private:
    ...
    //ticoin some columns have a hidden column containing the value used for sorting
...
#endif //ticoin COINCONTROLDIALOG_H
