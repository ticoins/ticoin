...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    {
        //ticoin First part of help message is specific to RPC client
        std::string strUsage = _("ticoin Core RPC client version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ticoin-cli [options] <command> [params]  " + _("Send command to ticoin Core") + "\n" +
              "  ticoin-cli [options] help                " + _("List commands") + "\n" +
              "  ticoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
