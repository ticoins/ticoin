...
protected:
    ...
    bool Write(const K& key, const T& value, bool fOverwrite=true)
    {
        ...
        //ticoin Clear memory in case it was a private key
        memset(datKey.get_data(), 0, datKey.get_size());
        memset(datValue.get_data(), 0, datValue.get_size());
        return (ret == 0);
    }
