...
unlocked to sign the ticoin-Qt.app bundle.
...
allowing somebody to distribute a ticoin-Qt.app or ticoin-qt-setup.exe with a valid
...
that the ticoin-qt.exe file inside the installer had not been tampered with.
